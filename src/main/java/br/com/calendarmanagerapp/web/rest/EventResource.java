...
import br.com.calendarmanagerapp.service.EventService;
...
/**
 * REST controller for managing {@link br.com.calendarmanagerapp.domain.Event}.
 */
@RestController
@RequestMapping("/api")
public class EventResource {
    ...
    public List<EventDTO> getAllEvents() {
        ...
        return eventService.findAllByUserLogin();
    }
