<template>
  <b-navbar data-cy="navbar" toggleable="md" type="dark" class="bg-info">
    <b-navbar-brand class="logo" b-link to="/">
      <span class="logo-img"></span>
      <span v-text="$t('global.title')" class="navbar-title">calendarManagerApp</span> <span class="navbar-version">{{ version }}</span>
    </b-navbar-brand>
    <b-navbar-toggle
      right
      ...
      <b-navbar-nav class="ml-auto">
        ...
        >
          <span slot="button-content" class="navbar-dropdown-menu">
            ...
            <span class="no-bold" v-text="$t('global.menu.account.main')" v-if="!authenticated"> Account </span>
            <span class="no-bold" v-text="$store.getters.account.login" v-if="authenticated"> </span>
          </span>
